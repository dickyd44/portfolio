            ...
            <div key={idx} className="overflow-hidden relative group">
              <Link href={img.link} target="_blank">
                <Image
                  ...
                  width={1000}
                  height={1000}
                  className="h-[390px] 2xl:h-[350px] xl:h-[300px] lg:h-[250px] md:h-[340px] w-full object-cover rounded-sm group-hover:scale-105 transition-all duration-300 ease-in-out coursor-pointer"
                />
